...
input_dir = '/Users/ali_nayeem/PycharmProjects/pasta-extension/scripts/output/5obj-15iter'
out_dir = '/Users/ali_nayeem/PycharmProjects/pasta-extension/latex/figure/15iter-5-obj'
Data = [ 'BB20001', 'BB20010', 'BB20022', 'BB20033', 'BB20041']
...
df_base = pd.read_csv(input_dir + '/' + 'base-output' + '/' + 'treePerf.txt', sep=', ', index_col='Dataset')
df_base_muscle = pd.read_csv(input_dir + '/' + 'base-muscle-output' + '/' + 'treePerf.txt', sep=', ',
                             index_col='Dataset')
# df_muscle = pd.read_csv(input_dir + '/' + 'muscle-output' + '/' + 'treePerf.txt', sep=', ',
#                              index_col='Dataset')
