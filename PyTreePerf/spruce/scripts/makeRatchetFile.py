...
desc = ' '.join(['This script writes a Nexus file with a matrix of binary', 
                 'character encodings of the trees read from input followed by', 
                 'PAUP* commands for performing a ratcheted MRP analysis.  Trees', 
                 'must be specified in Newick format.'])
