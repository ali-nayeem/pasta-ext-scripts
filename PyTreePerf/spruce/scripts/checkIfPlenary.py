...
desc = ' '.join(['This script reads a set of source trees and a set of',
                 'supertrees on those source trees as inputs.  If any of the',
                 'supertrees are non-plenary, a summary message is printed',
                 'along with a list containing only the plenary supertrees.',
