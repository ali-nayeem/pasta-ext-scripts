...
desc = ' '.join(['This script reads an input tree and prints the degrees of', 
                 'polytomies and the number of such occurrences in the tree.', 
                 'The tree must be specified in Newick format.'])
