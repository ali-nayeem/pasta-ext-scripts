...
desc = ' '.join(['This script reads a tree and prints its resolution, defined', 
                 'as the number of internal edges in the tree divided by n - 3,', 
                 'where n denotes the number of leaves in the tree.  The tree', 
